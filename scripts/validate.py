...
REQUIRED = [
    ...
    "src/firstwindow/system_status.py","src/firstwindow/onboarding.py","src/firstwindow/demo_project.py","src/firstwindow/windows_paths.py","src/firstwindow/resume.py",
